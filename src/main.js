...
document
	...
	.addEventListener('click', closeProgramWindo);

// If tetris is open before clock, the tetris canvas is lost.
document
	.querySelector('.special-tetris-container-to-getaround-bug-i-cannot-fix')
	.addEventListener('click', closeProgramWindo);
...
document
	.querySelector('.mid-taskbar')
	.addEventListener('minimisedProgram', (e) => {
...
document
	.querySelector('.mid-taskbar')
	.addEventListener('minimisedExplorer', (e) => {
		addLaunchExplorerListener(e);
	});

// programUtil.js dispatchs 'programClosed' event | remove taskbar item
document
	.querySelector('.mid-taskbar')
	.addEventListener('programClosed', (e) => {
		removeTaskItemOnClose(e);
	});

// desktopIconUtil.js dispatchs 'explorerClosed' event | remove taskbar item
document
	.querySelector('.mid-taskbar')
	.addEventListener('explorerClosed', (e) => {
		removeTaskItemOnClose(e);
	});
