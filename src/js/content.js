import {
	...
	dispatchClosedEvent,
} from './programs/tetris/tetrisUtil.js';
...
export const programConfigs = {
	...
	Tetris: {
		...
		onProgramOpen: (tetris) => {
			(programConfigs.tetrisInstance = tetris), tetris.initCtx();
	...
	DateTimeUI: {
		onProgramOpen: (dateTimeUI) => {
			(programConfigs.dateTimeUIInstance = dateTimeUI), dateTimeUI.initClock();
